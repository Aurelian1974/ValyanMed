...
namespace Application.Services
{
    public class MedicamentService : IMedicamentService
    {
        ...
        public Task<PagedResult<MedicamentDTO>> GetPagedAsync(string? search, string? status, int page, int pageSize, string? sort) => _repo.GetPagedAsync(search, status, page, pageSize, sort);
    }
}
