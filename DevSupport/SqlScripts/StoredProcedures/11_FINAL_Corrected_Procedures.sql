/*
    Final corrected stored procedures based on actual DTO structure
    LocalitateDto uses: IdOras, LocalitateGuid, IdJudet, Nume, Siruta
*/
...
BEGIN
    ...
    SELECT 
        IdOras,               -- This is the correct primary key name
        LocalitateGuid,
        IdJudet,
        Nume,
        Siruta
...
-- Test the procedures
PRINT 'Testing final corrected procedures...'
...
PRINT 'Final procedure creation and testing completed!';